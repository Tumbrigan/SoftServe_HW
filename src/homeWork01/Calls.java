...
public class Calls {
    ...
    public static void main(String[] args) {
        try (BufferedReader reader = new BufferedReader(new InputStreamReader(System.in))) {
            ...
            double price1 = Double.parseDouble(reader.readLine());
            ...
            System.out.print("Price per minute: ");
            double price2 = Double.parseDouble(reader.readLine());
            System.out.print("Сall duration: ");
            int duration2 = Integer.parseInt(reader.readLine());

            System.out.print("\n3rd country: ");
            String country3 = reader.readLine();
            System.out.print("Price per minute: ");
            double price3 = Double.parseDouble(reader.readLine());
            System.out.print("Сall duration: ");
